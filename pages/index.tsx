	...
	return (
		<>
			...
			<ModernBtn
				...
				text='Проекты'
				className='flex md:hidden absolute z-10 -bottom-24 right-6 w-[110px] h-[30px] text-white'
			/>
			<ModernBtn
				tag='link'
				href='/market'
				...
				border={'2px solid #fff'}
				text='Маркет'
				className='flex md:hidden absolute z-10 -bottom-56 left-6 w-[110px] h-[30px] text-white'
			/>
			<ModernHeading
			...
			<FadeIn className='relative cont pb-8 z-10'>
				<p>
					...
					художественного оформления. В разделе Маркет Вы можете выбрать из
					готовых художественных решений.
					<br />
					<br />
					Также мы предоставляем консультации по тематике нашей студии, мы можем
			...
			<FadeIn className='cont py-8'>
				<p>
					Каждый проект в нашей студии выполняется с учетом специфики, мы
					предоставляем услуги как частным клиентам, так и студиям, занимающимся
					архитектурным проектированием. Архитектурные фирмы обращаются к нам,
					потому что мы можем привнести уникальность в изначальный проект,
					увеличить чек общей сметы, а соответственно и выручку. Частных
					клиентов мы можем заинтересовать комплексным исполнением проекта от
					начала до конца, взяв на себя весь технический процесс. <br />
					Отработанная система поставщиков и подрядчиков позволяет осуществлять
					работу в кратчайшие сроки, а используемые в производстве материалы –
			...
			<FadeIn className='cont pt-8'>
				<p>
					...
					заказчика. Примеры применения опыта и технологий нашей студии, Вы
					можете увидеть в портфолио.
				</p>
